...
export const GAME_TIERS: Partial<Record<GameKey, string[]>> = {
  ...
  starcraft: ['브론즈', '실버', '골드', '플래티넘', '다이아몬드', '마스터', '그랜드마스터'],
  eternalreturn: ['아이언', '브론즈', '실버', '골드', '플래티넘', '다이아몬드', '메테오라이트', '미스릴', '데미갓', '이터니티'],
  kart: ['루키', '아마추어', '세미프로', '프로', '챔피언', '레전드'],
  apex: ['브론즈', '실버', '골드', '플래티넘', '다이아몬드', '마스터', '프레데터'],
...
export const SKILL_LABEL: Record<GameKey, string> = {
  ...
  maple: '레벨 / 직업',
  sudden: '계급',
  // 엔씨 게임들은 랭크 등급이 아니라 레벨과 서버로 서로를 가늠한다
  lineage: '레벨 / 서버',
  aion: '레벨 / 직업',
  bns: '레벨 / 직업',
  tl: '레벨 / 서버',
